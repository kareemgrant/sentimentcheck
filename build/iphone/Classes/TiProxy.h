...
//Rare exceptions to indicate a bug in the _sentimentcheck code (Eg, function that a subclass should have implemented)
...
/**
 The base class for SentimentCheck proxies.
 */
