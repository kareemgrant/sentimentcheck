...
/**
 The base class for all SentimentCheck modules
 */
...
/**
 SentimentCheck Platform calls this method on startup.
 */
-(void)startup;

/**
 SentimentCheck Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 SentimentCheck Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 SentimentCheck Platform calls this method on resume.
 @param sender The sender of the event.
 */
