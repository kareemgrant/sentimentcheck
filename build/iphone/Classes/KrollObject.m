 ...
 * Copyright (c) 2009-2011 by SentimentCheck, Inc. All Rights Reserved.
...
//@interface SentimentCheckObject : NSObject
//@end

@interface SentimentCheckObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SentimentCheckObject class]])
		{
			for (NSString *key in [[(SentimentCheckObject*)o modules] allKeys])
			{
