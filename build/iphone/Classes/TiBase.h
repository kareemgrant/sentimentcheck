...
// in simulator we redefine to format for SentimentCheck Developer console
...
{\
	NSString * exceptionName = [@"org.sentimentcheck." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sentimentcheck";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISentimentCheckNativeItemNone = -1, 
	UISentimentCheckNativeItemSpinner = -2,
	UISentimentCheckNativeItemProgressBar = -3,
	
	UISentimentCheckNativeItemSlider = -4,
	UISentimentCheckNativeItemSwitch = -5,
	UISentimentCheckNativeItemMultiButton = -6,
	UISentimentCheckNativeItemSegmented = -7,
	
	UISentimentCheckNativeItemTextView = -8,
	UISentimentCheckNativeItemTextField = -9,
	UISentimentCheckNativeItemSearchBar = -10,
	
	UISentimentCheckNativeItemPicker = -11,
	UISentimentCheckNativeItemDatePicker = -12,
	
	UISentimentCheckNativeItemInfoLight = -13,
	UISentimentCheckNativeItemInfoDark = -14,
	
	UISentimentCheckNativeItemDisclosure = -15,
	
	UISentimentCheckNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SentimentCheck instances of
