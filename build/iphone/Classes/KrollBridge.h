...
@interface SentimentCheckObject : KrollCoverageObject {
#else
@interface SentimentCheckObject : KrollObject {
#endif
@private
...
extern NSString * SentimentCheck$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SentimentCheckObject *_sentimentcheck;
	BOOL shutdown;
